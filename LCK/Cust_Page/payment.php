...
<!-- order details -->
<div class="container bg-light w-50 rounded<?php if (empty($_SESSION['foodItems'])) echo ' d-none'; ?>">
    <!-- Calculate order -->
    <?php
    // Calculate Sub Total
    $subTotal = 0;
    ...
    <!-- Receipt Display -->
    <div class="container bg-light w-75 rounded<?php if (empty($_SESSION['foodItems'])) echo ' d-none'; ?>">
    <br>
...
<?php
    ...
    ";
        ...
        $db_select = mysqli_select_db($conn, 'lck_database') or die(mysqli_error());
