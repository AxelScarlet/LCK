            ...
            if ($res == TRUE) {
                ...
                if ($count > 0) {
                    while ($rows = mysqli_fetch_assoc($res)) {
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center">
                                    <a href="<?php echo SITEURL; ?>Cust_Page/viewCart.php?id=<?php echo $id; ?>&orderID=<?php echo $orderID ?>" class="btn btn-warning me-2">View<br>Cart</a>
                                    <?php if (!$hideActions) { ?>
                                        <!-- Button to Open the Modal -->
                                        <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#orderReceivedModal<?php echo $orderID; ?>">Order<br>Received</button>
                                        <button type="button" class="btn btn-danger me-2" data-bs-toggle="modal" data-bs-target="#cancelOrderModal<?php echo $orderID; ?>">Cancel<br>Order</button>
                                    <?php } ?>
                                </div>
                            </td>
                        </tr>
                        ...
                        <div class="modal fade" id="orderReceivedModal<?php echo $orderID; ?>" tabindex="-1" aria-labelledby="orderReceivedModalLabel<?php echo $orderID; ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="orderReceivedModalLabel<?php echo $orderID; ?>">Order Received?</h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="<?php echo SITEURL; ?>Cust_Page/updateOrder.php?id=<?php echo $id; ?>&orderID=<?php echo $orderID ?>" class="btn btn-primary">Confirm</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Cancel Order Modal -->
                        <div class="modal fade" id="cancelOrderModal<?php echo $orderID; ?>" tabindex="-1" aria-labelledby="cancelOrderModalLabel<?php echo $orderID; ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="<?php echo SITEURL; ?>Cust_Page/cancelOrder.php?id=<?php echo $id; ?>&orderID=<?php echo $orderID ?>" class="btn btn-danger">Yes, Cancel Order</a>
                                    </div>
                                </div>
                            </div>
                        </div>
