                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <a href="<?php echo SITEURL; ?>Staff_Page/changePasswordCust.php?id=<?php echo $id; ?>" class="btn btn-primary blueBtn me-2">Change Password</a>
                                        <a href="<?php echo SITEURL; ?>Staff_Page/updateCust.php?id=<?php echo $id; ?>" class="btn btn-success greenBtn me-2">Update Customer</a>
                                        <a href="<?php echo SITEURL; ?>Staff_Page/deleteCust.php?id=<?php echo $id; ?>" class="btn btn-danger redBtn">Delete Customer</a>
                                    </div>
                                </td>
                            </tr>
                            <?php
