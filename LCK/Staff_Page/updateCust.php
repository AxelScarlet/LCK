    ...
    <div class="container-fluid dark-container bg-dark">
        <form action="" method="post">
            <fieldset>
                ...
                <legend class="text-center">Update Customer</legend>
                <input type="hidden" name="id" value="<?php echo $id; ?>"> <!-- Add hidden input field for the ID -->
                <div class="mb-3">
                    <label for="email" class="form-label">Email:</label>
                    <input type="email" class="form-control" id="email" placeholder="Enter email" name="custEmail" value="<?php echo $email; ?>" required>
                </div>
                <div class="mb-3">
                    <label for="fullname" class="form-label">Full Name:</label>
                    <input type="text" class="form-control" id="fullname" placeholder="Enter full name" name="custName" value="<?php echo $custName; ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="phone" placeholder="Enter phone number" name="custPhoneNumber" value="<?php echo $phoneNum; ?>" required>
                </div>
            </fieldset>
